...
namespace Game {
    public class ASMSettingsSetterBlock : GenerateASMWireVerticesBlock {
        ...
        public override void DrawBlock(PrimitivesRenderer3D primitivesRenderer, int value, Color color, float size, ref Matrix matrix, DrawBlockEnvironmentData environmentData) {
            ...
            flatBatch3D.QueueLineStrip([v3, v5, v6, v4], Color.Green);
            flatBatch3D.QueueLineStrip([v7, v8, v10, v9], Color.Green);
            flatBatch3D.QueueLineStrip([v3, v4, v8, v7], Color.Green);
            flatBatch3D.QueueLineStrip([v5, v9, v10, v6], Color.Green);
            flatBatch3D.QueueLineStrip([v3, v7, v9, v5], Color.Green);
            flatBatch3D.QueueLineStrip([v4, v6, v10, v8], Color.Green);
        }
    }
}