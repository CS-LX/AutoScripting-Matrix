namespace Game {
    public struct ASMDecomposerInfo(string displayName, string description, string texture, ASMElectricConnectorDirection[] inputDirections, ASMElectricConnectorDirection[] outputDirections, bool isDisplay = true, string extraDesc = "") {
