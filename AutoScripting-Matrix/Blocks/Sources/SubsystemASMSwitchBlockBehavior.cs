...
namespace Game {
    public class SubsystemASMSwitchBlockBehavior : SubsystemEditableItemBehavior<ASMatrixData> {

        public SubsystemASMSwitchBlockBehavior() : base(ASMSwitchBlock.Index) { }

        public override int[] HandledBlocks => [ASMSwitchBlock.Index];
