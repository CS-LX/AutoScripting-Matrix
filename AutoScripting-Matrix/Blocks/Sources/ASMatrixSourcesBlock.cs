...
namespace Game
{
    public class ASMatrixSourcesBlock : ASMRotateableMountedElectricElementBlock
    {
        ...
        public readonly MatrixSourceInfo[] Infos = [
            ...
            new MatrixSourceInfo("矩阵源: 从位移创建", "", "ASMatrixSourceFromTranslation", [ASMElectricConnectorDirection.Left, ASMElectricConnectorDirection.Bottom, ASMElectricConnectorDirection.Right, ASMElectricConnectorDirection.In], [ASMElectricConnectorDirection.Top]),
            new MatrixSourceInfo("矩阵源: 从欧拉角(三轴旋转)创建", "", "ASMatrixSourceFromYPR", [ASMElectricConnectorDirection.Left, ASMElectricConnectorDirection.Bottom, ASMElectricConnectorDirection.Right, ASMElectricConnectorDirection.In], [ASMElectricConnectorDirection.Top]),
            ...
            new MatrixSourceInfo("矩阵源: 从三轴缩放创建", "", "ASMatrixSourceFromScaleXYZ", [ASMElectricConnectorDirection.Left, ASMElectricConnectorDirection.Bottom, ASMElectricConnectorDirection.Right, ASMElectricConnectorDirection.In], [ASMElectricConnectorDirection.Top]),
