...
namespace Game {
    public class ASMDispenserWidget : CanvasWidget {
        ...
        public override void Update() {
            ...
            if(m_lastMatrixButton.IsClicked) DialogsManager.ShowDialog(m_componentPlayer.GuiWidget, new MessageDialog("上一次输入电压", m_element?.m_voltage.ToString(), "确定", null, null));
